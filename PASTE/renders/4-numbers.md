...
### Numbers 3: The Levites in Place of the Firstborn

| Verse | Word-for-word | In the text now |
|---|---|---|
| 1 | *toledot* | the begettings (as in Genesis) |
| 3 | *mille yadam*, "he filled their hand" | ***KEPT AS IS*** whose hand he filled (the ordination idiom, kept as in Exodus 29 and Leviticus 8; the note says what it means) |
| 4 | *al penei*, "on the face of" | in the presence of |
| 7 | *mishmeret* | charge (as 1:53) |
| 9 | *netunim netunim*, "given, given" | wholly given |
| 12 | *hinneh* | And I — here, I have taken |
| 12 | *peter rechem* | opener of the womb (as Exodus 13) |
| 26, 31, 36 | *le-khol avodato*, "for all its service" | all the work of it |
| 32 | *nesi nesi'ei*, "chief of the chiefs" | the chief over the chiefs |
| 36 | *pequddat mishmeret*, "the appointment of the charge" | the appointed charge |
| 38 | *miqdash* | the sanctuary |
| 39 | 22,000 (the clans add up to 22,300) | ***KEPT AS IS*** twenty-two thousand (note gives the sum, the Greek's 22,150, and the one-letter possibility) |
| 47 | *la-gulgolet*, "by the skull" | head by head |
| 47, 50 | *sheqel ha-qodesh* | the shekel of the sanctuary (see Choices) |

### Numbers 4: Carrying the Holy Things

| Verse | Word-for-word | In the text now |
|---|---|---|
| 2, 22 | *naso et rosh*, "lift the head" | take a count (as 1:2) |
| 3 | *kol ba la-tsava*, "all who come to the army" | all who enter the service |
| 3 | thirty years (Greek: twenty-five) | ***KEPT AS IS*** thirty years old (the Hebrew in all seven places; see Choices) |
| 4, 19 | *qodesh ha-qodashim* | the most holy things |
| 5 | *parokhet ha-masakh* | the veil of the screen (as Exodus 35, 39, 40) |
| 6 | *beged kelil tekhelet*, "a garment wholly blue" | a cloth all of blue |
| 6 | *tachash* | fine leather (as Exodus) |
| 7 | *shulchan ha-panim*, "table of the face" | the table of the Presence |
| 10, 12 | *mot* | the carrying frame |
| 13 | *dishnu*, "de-ash" | clear the ashes |
| 14 | the Greek adds the bronze basin | ***KEPT AS IS*** Hebrew only; the Greek sentence is in the note (see Choices) |
| 20 | *ke-valla*, "as a swallowing" | even for an instant |
| 23 | *litsbo tsava*, "to muster a muster" | to serve in the service (the doubling kept; the note explains the army word) |
| 47 | *avodat avodah*, "the work of work" | the work of serving |

### Numbers 5: The Camp Kept Clean

| Verse | Word-for-word | In the text now |
|---|---|---|
| 2 | *tsarua* | everyone with blight (fixed term) |
| 2 | *tamei la-nefesh*, "unclean for a soul" | unclean by a dead person (as Leviticus 22:4) |
| 6 | *li-m'ol ma'al*, "to break a breaking of faith" | breaking faith |
| 7 | *heshiv et ashamo be-rosho*, "return his guilt at its head" | pay back what he is guilty of in full |
| 8 | *ha-asham ha-mushav*, "the guilt returned" | the payment made |
| 13 | *shikhvat zera*, "a lying of seed" | lies with her |
| 15 | *mazkeret avon* | bringing guilt to remembrance (*avon* = guilt, as Leviticus 16:21) |
| 18 | *u-fara et rosh*, "loosen the head" | let the hair of the woman's head hang loose (as Leviticus 13:45) |
| 18 | *mei ha-marim ha-me'arerim*, "the waters of the bitterness, the cursing ones" | the water of bitterness that brings the curse |
| 19, 20, 29 | *tachat ishekh*, "under your husband" | ***KEPT AS IS*** while under your husband (it means while married to him; plain enough in context) |
| 21, 27 | *yarekh nofelet… beten tsavah* | ***KEPT AS IS*** your thigh fall away and your belly swell (the condition is not known; the note says so) |
| 24 | *le-marim*, "for bitterness" | become bitter |
| 28 | *ve-nizre'ah zara*, "be sown with seed" | conceive children (literal form in the note) |

### Numbers 6: The Nazirite and the Blessing

| Verse | Word-for-word | In the text now |
|---|---|---|
| 2 | *yafli lindor*, "makes wonderful to vow" | makes a special vow (as Leviticus 27:2) |
| 2 | *le-hazzir*, "to separate" | to keep himself apart (as Leviticus 22:2) |
| 3 | *mishrat anavim*, "soaking of grapes" | grape juice of any kind |
| 4 | *chartsannim… zag* (each occurs only here) | ***KEPT AS IS*** from the seeds to the skin (the usual reading; the Greek reverses it) |
| 5 | *pera* | the locks of the hair |
| 6 | *nefesh met*, "a dead soul" | a dead body (as Leviticus 21:11) |
| 7 | *nezer* | the crown (as Exodus 29:6) |
| 9 | *be-feta pit'om*, "suddenly, suddenly" | very suddenly |
| 9, 18 | *rosh nizro*, "the head of his separation" | his consecrated head |
| 11 | *al ha-nafesh*, "concerning the soul" | by reason of the dead |
| 12 | *yippelu*, "shall fall" | shall fall away |
| 21 | *asher tassig yado*, "what his hand can reach" | whatever else he can afford |
| 26 | *ve-yasem lekha shalom*, "and set peace for you" | and give you peace |

### Choices for you

1. **The shekel wording.** New in this cycle: 3:47 and 3:50 read *the shekel of the sanctuary*, as Leviticus 27 does. This chapter has both Hebrew words side by side, so it helps decide the open question:
   - *qodesh* (the shekel's word, and *the charge of the holy place*, 3:28, 32)
   - *miqdash* (*the charge of the sanctuary*, 3:38)

   One Hebrew word, one English word would make the shekel **of the holy place**. Every verse involved:
   - *of the sanctuary* now: Exodus 30:13, 24; Leviticus 27:3, 25; Numbers 3:47, 50
   - *of the holy place* now: Exodus 38:24–26; Leviticus 5:15

   **Recommendation: "of the holy place" everywhere**, which keeps *sanctuary* for *miqdash*.
2. **4:14, the Greek's extra sentence about the basin.** The Greek adds: *and they shall take a purple cloth and cover the basin and its stand, and put them into a blue leather covering, and put them on a carrying frame.* The Hebrew never says who carries the basin. **Recommendation: leave it out of the text** and keep it in the note. Nothing else in the Bible confirms the sentence, and it may be a scribe's filling of a gap.
3. **4:3 and six more verses: thirty years old or twenty-five.** The Hebrew says thirty in all seven verses (4:3, 23, 30, 35, 39, 43, 47), and the Greek says twenty-five in all seven. The Hebrew of 8:24 itself says twenty-five. **Recommendation: keep thirty.** The Hebrew is consistent within this chapter, and the note shows the difference.

Still open from earlier reports: *qeri* (Leviticus 26), *elef*, Deuel or Reuel, and the optional 23:11 note.

## Numbers 1–2 (routine fired 1:01 PM Central, 2026-09-24; reported with Leviticus 26–27)

**Landed:** Numbers 1, 2. Progress **147 of 1,554 (9.5%)** after this cycle.
...
**1. *elef* (the census): "thousand" or "clan"?** Numbers 1:16 ("the heads of the thousands of Israel") and every total in 1:21–46 and 2:4–32. Judges 6:15 uses *elef* for Gideon's clan. The text's own sums (1:46, 2:32) and Exodus 38:26 add up on the *thousand* reading. My recommendation: keep "thousand"; the note on 1:16 gives both.

**2. Gad's chief's father: Deuel or Reuel?**
